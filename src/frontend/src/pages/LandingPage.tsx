...
const teamMembers = [
  ...
  },
  {
    ...
    specialization: "Root Canal Treatment (RCT), Endodontics & Oral Surgery",
    bio: "Dr. Ankit Shrivastava holds an MDS (Master of Dental Surgery) degree and brings over 15 years of rich clinical experience to Dentocare Centre. As a highly qualified specialist, he has performed thousands of successful root canal treatments, complex extractions, and endodontic procedures. His expertise with advanced rotary endodontic systems ensures virtually painless, precise, and long-lasting results. Dr. Ankit is deeply committed to staying current with the latest advancements in dental technology, making him one of the most trusted dental surgeons in Rishikesh. Patients appreciate his calm demeanor, thorough explanations, and gentle approach to even the most complex cases.",
  ...
  },
  {
    ...
    degree: "BDS",
    designation: "Dental Surgeon & Orthodontist",
    specialization: "Orthodontics, Braces, Aligners & Cosmetic Dentistry",
    bio: "Dr. Priya Shrivastava is a BDS-qualified dental surgeon with over 10 years of dedicated clinical experience in orthodontics and aesthetic dentistry. She has transformed countless smiles through expertly designed braces treatments, clear aligner therapies, and a wide range of cosmetic dental procedures. Known for her meticulous attention to detail and patient-centric approach, Dr. Priya takes the time to understand each patient's unique smile goals and crafts personalized treatment plans to achieve them. Her warm and reassuring manner has made her a favourite among patients of all ages -- especially children and those with dental anxiety. She continuously upgrades her skills with the latest techniques in smile designing and orthodontic care.",
